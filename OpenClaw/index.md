...
2. [安装指南](#-安装指南)
3. [快速开始](#-快速开始)
4. [Workspace 工作空间](#-workspace-工作空间)
5. [配置 openclaw.json](#️-配置-openclawjson)
6. [配置对话终端](#-配置对话终端channels)
7. [配置多智能体](#-配置多智能体multi-agent)
8. [技能安装](#-技能安装)
9. [常用 CLI 命令](#️-常用-cli-命令)
10. [安全最佳实践](#-安全最佳实践)
11. [故障排除](#-故障排除)
12. [资源链接](#-资源链接)
13. [总结](#-总结)
...
> ⚠️ **永远不要**在未经保护的情况下公开 DM：使用 `dmPolicy: "pairing"` 或 `allowlist` 而非 `open`
...
**文档整理时间：** 2026-03-13  
**来源：** https://vercel-deploy-livid-nine.vercel.app/
